  ...
  return (
    ...
    >
      ...
      <div className="relative w-full h-full flex flex-col">
        ...
        <div className="flex-shrink-0 p-4 border-b border-gradient-to-r from-slate-200/40 via-slate-300/20 to-slate-200/40 bg-gradient-to-r from-white/90 via-slate-50/80 to-white/90 backdrop-blur-md">
